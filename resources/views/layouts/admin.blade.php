...
<html lang="en">
  <head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="{{asset('assets/images/icon.jpg')}}" />
  </head>
  <body>
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="{{asset('index.html')}}"><h3>checkmate</h3></a>
          <a class="sidebar-brand brand-logo-mini" href="{{asset('index.html')}}"><h2>checkmate</h2></a>
        </div>
        <ul class="nav">
          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
              ...
              <li class="nav-item dropdown">
                ...
                <a class="dropdown-item preview-item"> <h6 class="p-3 mb-0">Profile</h6></a>
